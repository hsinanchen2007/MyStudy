### 解题思路：
智力题终究是智力题，真正的算法问题肯定不会是投机取巧能搞定的。所以，本文就借石头游戏来讲讲「假设两个人都足够聪明，最后谁会获胜」这一类问题该如何用动态规划算法解决。
...
![1](https://pic.leetcode-cn.com/82faff95fb6442c600ca72db5ad80359b52b5057e6a73f16ed07e17dd473d3b6-file_1564377204069){:width=500}
{:align=center}
...
![2](https://pic.leetcode-cn.com/4130c179b1539ca8f79cf11d060dcece59d6da8d1199330f0c4086f14e4b55c2-file_1564377204078){:width=500}
{:align=center}

这里需要注意一点，我们发现 $base case$ 是斜着的，而且我们推算 `dp[i][j]` 时需要用到 `dp[i+1][j]` 和 `dp[i][j-1]`：

![3](https://pic.leetcode-cn.com/f59bdc232e1be821fbcabc6640e9775bef5b4cbd0b2c653edc6e0db2c3d7440b-file_1564377204079){:width=500}
{:align=center}

所以说算法不能简单的一行一行遍历 $dp$ 数组，**而要斜着遍历数组：**

![4](https://pic.leetcode-cn.com/3b1adc86ba35fb78111ee6e1b6c38d7adac2f7da4169fbb076672d0351150c50-file_1564377204083){:width=500}
{:align=center}
