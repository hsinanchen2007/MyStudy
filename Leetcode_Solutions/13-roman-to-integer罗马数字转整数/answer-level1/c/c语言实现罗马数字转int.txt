...
待解决问题：1.如何对应到int值。
    利用函数的话，可以节约内存空间，使用时候会被释放。

  2.如何解决4 9 40 90等数据
    仔细观察，能在左边的要求右边值大于左边值，我们可以大胆认为只要左边小于右边，
    就利用碱法，减去当前的对应int值，同时直接加上右边的值。（至于这个想法对不对，
    我没验证过，如果有错的话，希望各位验证）

题外话：经常看到有人质疑运行时间之类的问题，别人运行时间这么短，自己却那么长，我觉得吧，
即使是同样的代码，你提交两次时间都可能出现前后不一致，主要是为了学别人的思路，又不是来
争论时间运行真的如我们所测试的那样短，多分享一下思路我觉得才是最重要的，时间什么的不重要。同样的程序，你们看看，两次时间都不一样
