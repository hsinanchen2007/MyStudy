首先这道题又是我用眼睛“看出来”的一道题。
其实我更觉得他不是代码题，而是一道数学题，找规律的题。
![看的过程](https://pic.leetcode-cn.com/292db98c4447882e3386ef1f1a9551fd8bf4a497ec53bf86d9397d64f9e81e19-file_1576308224417)
如图所示:4在谁手谁肯定会输。
...
然后这道题就是这么简单。判断给定数是不是4的倍数就可以：然后代码就是简单的两行：
