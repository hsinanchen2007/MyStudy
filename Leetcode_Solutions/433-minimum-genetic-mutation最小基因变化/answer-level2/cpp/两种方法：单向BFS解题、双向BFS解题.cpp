本题与[127.单词接龙](https://leetcode-cn.com/problems/word-ladder/)的[算法思路](https://blog.csdn.net/qq_43152052/article/details/102060189)一模一样，连代码都没什么大变化。
...
* 2）循环结束的条件是两个bfs碰头。每个单词遍历的方向，1由前向后遍历，2由后向前遍历，3两个bfs碰头。公式：`0|1=1、0|2=2、1|2=3`和`i&i=i、i&0=0`
```cpp
class Solution {
public:
    //解法2：双向bfs
