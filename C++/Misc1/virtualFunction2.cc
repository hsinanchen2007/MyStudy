/*
    ...
    is re-defined (overridden) by a derived class. When you refer to a derived class object 
    ...
    Rules for Virtual Functions
        ...
        for the derived class to override (or re-define the virtual function), in that case, the base 
        class version of the function is used.
